...
#     Returns:
#         str: The username of the currently logged-in user, or "unknown" if
# the username
...
#     log_exports(
# list(file_select_dict.values()), pipeline_run_datetime, OutgoingLogger
# )
