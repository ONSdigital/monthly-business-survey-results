...
|---|---|---|---|
| bucket | The path to the bucket. | str | Any filepath. |
| calibration_group_map_path | The filepath to the calibration group mapping file. | str | Any filepath. |
| classification_values_path | The filepath to the file containing SIC classification values. | str | Any filepath. |
| folder_path | The path to the folder containing input data. | str | Any filepath. |
| l_values_path | The filepath to the file containing l values. | str | Any filepath. |
| manual_constructions_path | The filepath to the file containing manual constructions data. | str | Any filepath. |
| mbs_file_name | The filepath to the input data. | str | Any filepath. |
| output_path | The filepath where outputs should be saved to. | str | Any filepath. |
| population_path | The filepath to the file containing population frame data. | str | Any filepath. |
| sample_path | The filepath for the file containing sample data. | str | Any filepath. |
| back_data_qv_path | The filepath for the file containing QV backdata. | str | Any filepath. |
| back_data_cp_path | The filepath for the file containing CP backdata. | str | Any filepath. |
| back_data_finalsel_path | The filepath for the file containing final selection backdata. | str | Any filepath. |
| sic_domain_mapping_path | The filepath for the data containing the mapping from SIC codes to domains. | str | Any filepath. |
| threshold_filepath | The filepath for the data containing thresholds for selective editing. | str | Any filepath. |
...
| revision_period | The number of months to use as a revision period. | int | Any int in the form `yyyymm`. |
...
|---|---|---|---|---|
| platform | Specifies whether you're running the pipeline locally or on DAP. | "s3" | str | "network", "s3" |
| back_data_type | The name of the backdata type marker column. | "type" | str | Any valid column name. |
| imputation_marker_col | The name of the column being used as an imputation marker. | "imputation_flags_adjustedresponse" | str | Any valid column name. |
...
| master_column_type_dict | Defines the expected data types for various columns. | N/A | dict | Any dictionary in the format {"column_name": "data_type"} where column name is a valid column and data_type is one of "bool", "int", "str" or "float". Both key and value should be enclosed in quotation marks. |
